package com.Aspen.utilities;
public class TestConfig{


	
	public static String server="smtp.gmail.com";
	public static String from = "jithinmathew65@gmail.com";
	public static String password = "!234Qwer";
	public static String[] to ={"jithin.mathew@aspen.edu"};
